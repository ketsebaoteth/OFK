  ...
  <div class="w-screen h-[50vh] p-10 px-5 z-400 bg-white">
    <div class="w-full h-full cov rounded-2xl flex flex-col gap-10 place-items-center justify-center">
      ...
      <p class="text-center w-100">
        At OFK Constructions, we understand that a home is more than just a structure; it's a sanctuary where memories are made.
      </p>
    </div>
  </div>
</template>
...
.cov {
  background: url('/ar1.png') no-repeat center center;
